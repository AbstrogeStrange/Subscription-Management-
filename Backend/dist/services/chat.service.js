...
const toMonthlyAmount = (amount, billingCycle) => {
...
exports.chatService = {
    ...
    async ask(userId, message, history = []) {
        ...
        const input = [
            {
                ...
                content: [
                    {
                        type: "input_text",
                        text: "You are a subscription finance assistant inside a SaaS app. Give concise, practical suggestions. Use INR and concrete actions. If asked about cancellation, suggest impact and alternatives.",
                    },
                ],
            },
            {
